...
dt=0.01;
T=0:dt:200;
no=length(T); %No of sample inputs
...
delta_t=0;
delta_r=0;
delta_a_array=zeros([1,no]);
delta_r_array=zeros([1,no]);
delta_a_array([1,4001:4500])=0.2;
delta_a_array([1,4501:5500])=-0.2;
delta_a_array([1,5501:6000])=0.2;
count=0;
angles=zeros([3,no]);
...
figure
plot(0:dt:200,delta_a_array,"Color",'r');
legend("\delta_a");
title("Control Surface Deflection vs Time")
xlabel("Time (in sec)");
...
angles=real(angles);
subplot(3, 1, 1);
plot(0:dt:200,mod(rad2deg(angles(1,:))+180,360)-180,"Color",'r');
ylabel("\phi in degrees");
title("\phi vs Time")
xlabel("Time (in sec)");
subplot(3, 1, 2);
plot(0:dt:200,mod(rad2deg(angles(2,:))+180,360)-180,"Color",'r');
ylabel("\theta ih degrees");
title("\theta vs Time")
xlabel("Time (in sec)");
subplot(3, 1, 3);
plot(0:dt:200,mod(rad2deg(angles(3,:))+180,360)-180,"Color",'r');
...
% end
% plot(0:dt:100,mod(rad2deg(alpha_m)+180,360)-180);
...
% end
% plot(0:dt:100,mod(rad2deg(beta_m)+180,360)-180);
% ylabel("\beta in degrees");
% xlabel("Time (in sec)");
% title("\beta vs Time")
% sgtitle("Va, \alpha, \beta vs Time")
% 
% % plot(0:dt:100,velocity_b(1,:));
% % hold on
% % plot(0:dt:100,velocity_b(2,:));
% % hold on
% % plot(0:dt:100,velocity_b(3,:));
% % 
% % legend('u','v','w');
% % 
...
% % plot (0:dt:100,Va_d);
% % hold on
% % plot(0:dt:100,gamma.*(mass*g));
% 
% figure
% subplot(3, 1, 1);
% plot(0:dt:100,moment(1,:));
% ylabel("l in N/m");
% title("l vs Time")
% xlabel("Time (in sec)");
% subplot(3, 1, 2);
% plot(0:dt:100,moment(2,:));
% ylabel("m in N/m");
% title("m vs Time")
% xlabel("Time (in sec)");
% subplot(3, 1, 3);
% plot(0:dt:100,moment(3,:));
% ylabel("n in N/m");
% title("n vs Time")
% xlabel("Time (in sec)");
% sgtitle("Moments in Body Frame vs Time")
% 
% figure
% plot(loc(2,:),loc(1,:),LineWidth=1.5);
% ylabel("North (in m)");
% xlabel("East (in m)");
% title("Path of Flight");
% 
% % figure
% % plot(0:dt:100,force(1,:));
% % hold on
% % plot(0:dt:100,force(2,:));
% % hold on
% % plot(0:dt:100,force(3,:));
% % legend('fx','fy','fz');
