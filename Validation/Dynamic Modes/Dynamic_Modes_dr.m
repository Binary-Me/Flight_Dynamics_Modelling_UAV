...
delta_r_array([1,4001:4500])=0.2;
delta_r_array([1,4501:5500])=-0.2;
delta_r_array([1,5501:6000])=0.2;
delta_a=0;
count=0;
angles=zeros([3,no]);
...
figure
plot(0:dt:200,delta_r_array);
ylabel("\delta_r");
title("\delta_r vs Time")
xlabel("Time (in sec)");
