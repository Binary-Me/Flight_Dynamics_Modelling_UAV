...
delta_r=0;
delta_t=0;
delta_e_array=-0.703975.*ones([1,no]);
delta_e_array([1,4001:4500])=-0.703975+0.2;
delta_e_array([1,4501:5500])=-0.703975-0.2;
delta_e_array([1,5501:6000])=-0.703975+0.2;
delta_a=0;
count=0;
angles=zeros([3,no]);
...
figure
plot(0:dt:200,delta_e_array);
ylabel("\delta_e");
title("\delta_e vs Time")
xlabel("Time (in sec)");
...
angles=real(angles);
subplot(3, 1, 1);
plot(0:dt:200,mod(rad2deg(angles(1,:))+180,360)-180);
ylabel("\phi in degrees");
title("\phi vs Time")
xlabel("Time (in sec)");
subplot(3, 1, 2);
plot(0:dt:200,mod(rad2deg(angles(2,:))+180,360)-180);
ylabel("\theta ih degrees");
title("\theta vs Time")
xlabel("Time (in sec)");
subplot(3, 1, 3);
plot(0:dt:200,mod(rad2deg(angles(3,:))+180,360)-180);
